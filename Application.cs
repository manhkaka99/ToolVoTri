...
namespace BimIshou
{
    ...
    public class Application : ExternalApplication
    {
        ...
        private void CreateRibbon()
        {
            ...
            string pdfPath = System.IO.Path.Combine(appDataPath, @"Autodesk\Revit\Addins\BimIshouHelp", "ToolVoTri.pdf");
            ContextualHelp contextualHelp = new ContextualHelp(ContextualHelpType.ChmFile, pdfPath);
            ...
            tagSite.SetContextualHelp(contextualHelp);
            ...
            tagDim.SetContextualHelp(contextualHelp);
            ...
            Tag防.SetContextualHelp(contextualHelp);
            ...
            floorSite.SetContextualHelp(contextualHelp);

            var areas = panel2.AddSplitButton("Area", "Áp dụng cho bản diện tích");
            areas.SetContextualHelp(contextualHelp);
            ...
            GridLevel.SetContextualHelp(contextualHelp);
            ...
            removeText.SetContextualHelp(contextualHelp);
            ...
            createRegion.SetContextualHelp(contextualHelp);
            ...
            checkTagWall.SetContextualHelp(contextualHelp);

            var dimWallPanel = panel2.AddSplitButton("Dim Wall", "Dim Wall");
            dimWallPanel.SetContextualHelp(contextualHelp);
            ...
            checkoutStatus.SetContextualHelp(contextualHelp);
